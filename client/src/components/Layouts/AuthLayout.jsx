  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="h-56 w-48 rounded-[40px] border-[20px] border-fuchsia-600 absolute top-[30%] -right-10"></div>
        <div className="h-48 w-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-5"></div>
